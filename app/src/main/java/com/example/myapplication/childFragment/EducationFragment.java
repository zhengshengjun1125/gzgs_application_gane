...
public class EducationFragment extends Fragment {
    ...
    private News_Edu_Adapter newsAdapter;
    private News news;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.education_fragment, container, false);
        ListView listView = view.findViewById(R.id.news_edu_lv);
        for (int i = 0; i < 20; i++) {
            //加二十条新闻
            news = new News();
            news.setTitle("测试标题");
            news.setMessage("内容测试_教育");
        ...
        newsAdapter = new News_Edu_Adapter(data,this);
